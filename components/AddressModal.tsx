...
// --- 1. Định nghĩa Interfaces cho dữ liệu Địa điểm ---
interface IWard {
  Code: string;
  FullName: string;
}
...
export default function AddressModal({
  ...
  // Ép kiểu cho data trả về từ hook (Giả sử hook trả về mảng IProvince)
  ...
  return (
    <div className="fixed inset-0 z-2000 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-white w-full max-w-lg rounded-4xl overflow-hidden relative shadow-2xl">
        {/* Header */}
        ...
        <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto">
          ...
          <div className="space-y-1">
            ...
            <button
              type="button"
              onClick={() => setStep(1)}
              className="w-full flex items-center justify-between p-4 bg-white border-2 border-gray-100 rounded-2xl hover:border-orange-200 transition-colors"
            >
              <span
                className={
                  address.province
          ...
          <div className="space-y-1">
            ...
            <button
              ...
              onClick={() => setStep(2)}
              className="w-full flex items-center justify-between p-4 bg-white border-2 border-gray-100 rounded-2xl disabled:bg-gray-50 disabled:opacity-60 transition-colors"
            >
              <span
                className={
                  address.ward ? "text-gray-800 font-semibold" : "text-gray-400"
                }
              >
          ...
          <div className="space-y-1">
            ...
            <input
              className="w-full p-4 border-2 border-gray-100 rounded-2xl outline-none focus:border-orange-400 font-semibold text-black transition-all"
          ...
          {/* Preview Address */}
          {address.ward && (
            <div className="bg-orange-50/50 border border-orange-100 p-4 rounded-2xl flex gap-3 animate-in fade-in slide-in-from-top-2">
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50/50">
          <button
            ...
            className="w-full py-4 bg-orange-500 hover:bg-orange-600 disabled:bg-gray-200 text-white font-extrabold rounded-2xl uppercase transition-all active:scale-[0.98]"
          >
            Hoàn tất
          </button>
        </div>
